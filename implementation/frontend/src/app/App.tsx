...
import { Layout, Role, Screen } from "./components/Layout";
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      case "book-appointment":
        return <BookAppointment userName={auth.userName} />;
      ...
      case "search-patient-appointments":
        return <SearchPatientAppointments />;
      case "manage-doctor-availability":
        return <ManageDoctorAvailability />;
      case "my-agenda":
        return <MyAgenda />;
      case "register-availability":
        return <RegisterAvailability />;
      case "profile":
        return <UserProfile role={auth.role} />;
      default:
        return null;
    }
  };
