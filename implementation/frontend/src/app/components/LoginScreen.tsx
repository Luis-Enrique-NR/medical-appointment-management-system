    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "linear-gradient(135deg, #0F96CB 0%, #05576D 100%)" }}>
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-center text-gray-500 mb-8" style={{ fontSize: 14 }}>
            Ingrese sus credenciales para continuar
          </p>

          {/* Error banner */}
          {error && (
            <div className="mb-4 flex items-start gap-2 bg-[#FF82B6]/15 border border-[#FF82B6]/40 text-[#c45c80] px-4 py-3 rounded-lg" style={{ fontSize: 14 }}>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3.5 py-2.5 bg-white border border-[#05576D]/30 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#006FC1]/30 focus:border-[#006FC1] transition-colors"
                style={{ fontSize: 15 }}
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2.5 pr-11 bg-white border border-[#05576D]/30 rounded-lg text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#006FC1]/30 focus:border-[#006FC1] transition-colors"
                  style={{ fontSize: 15 }}
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 bg-[#006FC1] hover:bg-[#005a9e] disabled:opacity-60 text-white py-2.5 rounded-lg font-medium transition-colors"
              style={{ fontSize: 15 }}
            >
          ...
          <div className="mt-6 p-3 bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div className="flex justify-center gap-4 flex-wrap">
              {Object.entries(DEMO_USERS).map(([u, d]) => (
                <button
                  key={u}
                  onClick={() => { setUsername(u); setPassword("clinifer"); setError(""); }}
